...
<body>
<h1 class="w3ls">Chỉnh sửa thông tin khách hàng  </h1>
...
<div class="content-agileits">
    <form action="{{route('customer.store')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group w3layouts w3 w3l">
            ...
            <input type="text" class="form-control" name="name" value="{{$customer->name}}"  placeholder="name" data-error="Enter Your First Name" required>
        ...
        <div class="form-group agileits w3layouts w3">
            ...
            <input type="text" class="form-control" name="age"  value="{{$customer->age}}" placeholder="age" data-error="Enter Your Last Name" required>
            <div class="help-block with-errors"></div>
        </div>
        ...
        <div class="form-group w3l agileinfo wthree w3-agileits">
            ...
            <input type="number" class="form-control" name="phone" value="{{$customer->phone}}"  placeholder="Phone" data-error="This email address is invalid" required>
            <div class="help-block with-errors"></div>
        </div>
        <div class="form-group agileinfo wthree w3-agileits agile">
            <label for="Phone" class="control-label">Image</label>
            <input type="file" name="img"  value="{{$customer->img}}"  class="form-control-file" placeholder="img" data-error="Enter Your Phone Number" required>
            <div class="help-block with-errors"></div>
        </div>

        <div class="form-group">
            <button type="submit" class="btn btn-lg">Thay đổi thông tin khách hàng ^^</button>
        </div>
    </form>
</div>
